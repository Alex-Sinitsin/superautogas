            ...
            <div class="flex justify-between items-center">
                <div class="page-title flex items-center">
                    ...
                    <div class="page-caption">
                        <p class="page-title block font-medium text-lg tracking-wider mb-0">Статистика Яндекс
                            Метрики</p>
                ...
                <div class="period-button-group">
                    <p class="">
                        <a href="#"
                           class="period-metrika-link px-3 py-1.5 mr-2  text-sm rounded hover:bg-blue-800 hover:text-white transition-colors  is-active">
                            <span>Неделя</span>
                        </a>
                        <a href="#"
                           class="period-metrika-link px-3 py-1.5 mr-2 text-sm rounded hover:bg-blue-800 hover:text-white transition-colors">
                            <span>Месяц</span>
                        </a>
                        <a href="#"
                           class="period-metrika-link px-3 py-1.5 mr-2 text-sm rounded hover:bg-blue-800 hover:text-white transition-colors">
                        ...
                        <a href="#"
                           class="period-metrika-link px-3 py-1.5 text-sm rounded hover:bg-blue-800 hover:text-white transition-colors">
                            <span>Год</span>
                        </a>
                    </p>
                </div>
