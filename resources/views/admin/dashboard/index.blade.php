...
@section('content')
    <div class="content p-5">
        <div class="page-header-card w-full mb-4 shadow-md p-3">
            <div class="flex justify-between items-center">
                ...
                <div class="period-button-group">
                    <p class="">
                        <a href="#" class="px-3 py-1.5 mr-2 border-2 border-gray-400 text-sm rounded hover:bg-amber-500 hover:text-white transition-colors  is-active">
                            <span>Неделя</span>
                        </a>
                        <a href="#" class="px-3 py-1.5 mr-2 border-2 border-gray-400 text-sm rounded hover:bg-amber-500 hover:text-white transition-colors">
                            <span>Месяц</span>
                        </a>
                        <a href="#" class="px-3 py-1.5 mr-2 border-2 border-gray-400 text-sm rounded hover:bg-amber-500 hover:text-white transition-colors">
                            <span>Квартал</span>
                        </a>
                        <a href="#" class="px-3 py-1.5 border-2 border-gray-400 text-sm rounded hover:bg-amber-500 hover:text-white transition-colors">
                            <span>Год</span>
                        </a>
                    </p>
                </div>
