            ...
            <div class="2xl:container 2xl:mx-auto py-8 px-4">
                ...
                <div class="row my-2 flex flex-wrap">
                                ...
                                <tr class="bg-white border-b">
                                    <td class="text-sm text-gray-900 font-light pl-4 py-4 text-left whitespace-nowrap">
                                        ...
                                        <span class="inline-block truncate align-middle">
                                            {{$page['dimensions']['URLPathFull']['favicon'] .
                                            $page['dimensions']['URLPathFull']['name']}}
                                        </span>
                                    </td>
                    ...
                    <div class="totals flex flex-col lg:px-12 w-full lg:w-fit">
                        ...
                        <x-widget title="Визиты" icon="sign-in" color="amber"
                            value="{{$visitors['totals'][0]['visits']}}" />
                        <x-widget title="Просмотры" icon="eye" class="bg-violet-200"
                            value="{{$visitors['totals'][0]['pageviews']}}" />
                        <x-widget title="Пользователи" icon="accounts" color="red"
                            value="{{$visitors['totals'][0]['users']}}" />
                    </div>
                </div>
            </div>
        </div>
